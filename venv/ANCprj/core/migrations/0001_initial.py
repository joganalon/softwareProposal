    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Meal', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, default='49.99', max_digits=999)),
                ('payment_status', models.BooleanField(default=False)),
                ('order_date', models.DateTimeField(auto_now_add=True)),
                ('product_status', models.CharField(choices=[('received', 'Order Received'), ('process', 'Food Preparation Ongoing'), ('prepared', 'Ready for Pickup'), ('collected', 'Order Collected')], default='received', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='49.99', max_digits=999)),
                ('total', models.DecimalField(decimal_places=2, default='49.99', max_digits=999)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.foodtray')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='Order now.', null=True)),
                ('price', models.DecimalField(decimal_places=2, default='49.99', max_digits=999)),
                ('old_price', models.DecimalField(decimal_places=2, default='59.99', max_digits=999)),
                ...
                ('updates', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='We are an amazing vendor.', null=True)),
                ('address', models.CharField(default='Ateneo', max_length=100)),
                ('contact', models.CharField(default='09091234567', max_length=100)),
