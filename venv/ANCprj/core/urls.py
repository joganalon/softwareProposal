...
from core.views import index, foodGroup_list_view, product_list_foodGroup_view, category_list_view, product_list_category_view, vendor_list_view, vendor_detail, product_detail_view, ajax_add_review, search_view, filter_product, add_to_orders
